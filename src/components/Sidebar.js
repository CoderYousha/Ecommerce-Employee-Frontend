...
function Sidebar() {
    ...
    return (
        <>
            {
                !wait &&
                <Box className='w-1/5 h-screen overflow-y-scroll none-view-scroll bg-white px-5 fixed left-0'>
                    <Box className='py-5 flex items-center'>
                        ...
                        <Box className='!ml-5 max-sm:hidden'>
                            ...
                            <Typography variant="body2"><FormattedMessage id='employee'/></Typography>
                        </Box>
                    </Box>
                    <Box className=''>
                        {
