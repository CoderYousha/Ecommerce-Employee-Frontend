function Translation() {
    return {
        en: {
            ...
            delete_banner_description: "Are you sure that you want delete this banner?",
            add_banner: "Add New Banner",
            total_banners: "Total Banners",
            search_banner: "Search Banners by Title",
            title: "Title",
            start_date: "Start Date",
            end_date: "End Date",
            update_banner: "Update Banner",
            search_order: "Search Order by ID",
        ...
        ar: {
            ...
            search_banner: "البحث عن إعلان من خلال العنوان",
            title: "العنوان",
            start_date: "تاريخ البدء",
            end_date: "تاريخ الانتهاء",
            update_banner: "تعديل الإعلان",
            search_order: "البحث عن طلب معين من خلال الرقم",
